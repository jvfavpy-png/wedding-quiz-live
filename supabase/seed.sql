...
select
  ...
  sample.difficulty,
  sample.base_points,
  sample.speed_bonus_enabled
from demo_event
cross join (
  values
    (1, '新郎新婦が初めて出会った場所は？', '職場', '友人の紹介', 'マッチングアプリ', '旅行先', 1, 10, 'easy', 50, true),
    (2, '新郎が新婦に初めてプレゼントしたものは？', '花', 'アクセサリー', 'お菓子', '手紙', 2, 10, 'normal', 100, true),
    (3, '新婦が新郎に直してほしいと思っていることは？', '寝落ち', '返信の速さ', '服の脱ぎっぱなし', '食べすぎ', 2, 10, 'hard', 150, true),
    (4, '新郎新婦が一番思い出に残っている旅行先は？', '北海道', '九州', '沖縄', '関西', 2, 10, 'special', 200, true),
    (5, '新郎新婦が将来一番大事にしたいことは？', 'お金', '健康', '笑い', '家族時間', 3, 10, 'final', 300, false)
) as sample(order_no, text, option_1, option_2, option_3, option_4, correct_index, time_limit_sec, difficulty, base_points, speed_bonus_enabled)
